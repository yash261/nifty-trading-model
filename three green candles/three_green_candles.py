...
# Create a Strategy
class three_green_candles(bt.Strategy):
    """A simple trending strategy; three consecutive green candles, trix >0 and solid body for buy and vice versa for sell"""
...
if __name__ == '__main__':
    ...
    cerebro.optstrategy(three_green_candles,optim=True, optim_variable=windows )#  optim=False, optim_variable=windows
